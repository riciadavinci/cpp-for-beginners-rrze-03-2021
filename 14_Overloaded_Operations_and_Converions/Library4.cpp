...
*
* \file Library4.cpp
* \brief C++ Training - Relational Operators Programming Task
*
...
*
* Task: Add the following operators to the 'Book' class:
*       1.) Rework the 'operator<(Book,Book)' to order based on lastname, firstname, and title;
*       2.) Add 'operator==(Book,Book)';
*       3.) Add 'operator!=(Book,Book)';
*       4.) Add 'operator>(Book,Book)';
*       5.) Add 'operator<=(Book,Book)';
*       6.) Add 'operator>=(Book,Book)'.
*
**************************************************************************************************/
