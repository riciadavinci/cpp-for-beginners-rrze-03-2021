...
*
* Task: Implement the 'Pricing' class, which provides the option to specify the pricing strategy
*       for books at runtime. Implement several possible derived classes, as for instance
*       'Discount' or 'ToEuro'. By default, prices should be accepted "as is". Also, extend the
*       Book class to enable the configuration by different pricing strategies.
*
**************************************************************************************************/
...
// TODO: Implement the 'Pricing' base class as the default pricing strategy.
...
// TODO: Implement the 'Discount' class as specialization of the 'Pricing' class.
...
// TODO: Implement the 'ToEuro' class as specialization of the 'Pricing' class.
...
class Book
{
 public:
   ...
   // TODO: Implement the 'setPricing()' function
